...
export const metadata:Metadata={metadataBase:new URL(company.origin),title:{default:'Faizan Al Rabee | Trading & Distribution',template:'%s | Faizan Al Rabee'},description:company.description,icons:{icon:'/favicon.svg'},openGraph:{type:'website',siteName:'Faizan Al Rabee Company',title:'Faizan Al Rabee — Your supply partner in Saudi Arabia',description:company.description}};
